...
A scenario where 'write' agents create entries, while 'get_agent_activity' agents create entries which are validated with a `must_get_agent_activty` call for a single 'write' agent's activity.

...
- **canonical-scaled**: Same as canonical, but for runs with very large numbers of nodes. When our nomad cluster lacks the required nodes, the rest will be deployed via Threefold for the duration of the run.
...
```bash
nomad job run -address=http://localhost:4646 -var scenario_url=result/bin/app_install -var reporter=in-memory -var holochain_bin_url=https://github.com/holochain/holochain/releases/download/holochain-0.6.1/holochain-x86_64-unknown-linux-gnu nomad/job-variants/demo/jobs/app_install_minimal.nomad.hcl
```
...
```bash
nomad job run -var scenario_url=http://{some-url} -var holochain_bin_url=https://github.com/holochain/holochain/releases/download/holochain-0.6.1/holochain-x86_64-unknown-linux-gnu nomad/job-variants/demo/jobs/app_install_minimal.nomad.hcl
```
...
like to test a different version of Holochain, the default is the latest 0.6.x release, at the time of writing
<https://github.com/holochain/holochain/releases/download/holochain-0.6.1>.
...
- For Holochain [0.7.0-rc.1](https://holochain.github.io/wind-tunnel/run.20260728210601.705fb1a3cc6c63838e558f98a034b72aac36f9df.html#scenario-4) with 30 nodes
...
| v0.6.0 | 0.6.0 | 0.3.0 |
| v0.5.0 | 0.5.6 | 0.1.16 |
| v0.5.0-dev.0 | 0.5.3 | 0.1.9 |
| v0.4.0-dev.1 | 0.4.2 | 0.0.1-alpha9 |
| 0.2.0-alpha.2 | 0.3.1-rc.0 | N/A |
| 0.2.0-alpha.1 | 0.3.0-beta-dev.43 | N/A |
| 0.1.0-alpha.3 | 0.2.6 | N/A |
| 0.1.0-alpha.2 | 0.2.6 | N/A |
| 0.1.0-alpha.1 | 0.2.6 | N/A |

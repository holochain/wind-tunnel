    ...
    flake-parts.lib.mkFlake { inherit inputs; } {
      ...
      perSystem =
        ...
        let
          ...
          threefold-deployer = pkgs.buildGoModule {
            pname = "threefold-deployer";
            version = "0.1.0";
            src = ./threefold/deployer;
            vendorHash = "sha256-N9H5gYSg3qyFdjGXKcjUrLGurroV+E/nmjrFSmmi70s=";
            env = {
              CGO_ENABLED = "0";
              GOWORK = "off";
            };
        ...
        in
        {
          ...
          packages = {
            ...
            inherit lp-tool;
            inherit threefold-deployer;
            inherit tfgrid-sdk-go-tf-grid-cmd;
            ...
            rust-smoke-test = pkgs.writeShellApplication {
              ...
              runtimeEnv = {
                inherit (self'.devShells.default) UNYT_DURABLE_OBJECTS_URL UNYT_DURABLE_OBJECTS_SECRET;
              };
              runtimeInputs = [
                config.rustHelper.rust
                customHolochain
